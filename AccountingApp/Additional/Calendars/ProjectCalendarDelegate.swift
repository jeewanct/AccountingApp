...
extension ProjectCalendar: JTAppleCalendarViewDelegate, JTAppleCalendarViewDataSource{
    ...
    func configureCalendar(_ calendar: JTAppleCalendarView) -> ConfigurationParameters {
       ...
       // return ConfigurationParameters(startDate: startDate, endDate: endDate, numberOfRows: 7, calendar: Calendar.current, generateInDates:  .forAllMonths, generateOutDates: .tillEndOfGrid, firstDayOfWeek: .sunday, hasStrictBoundaries: false)
    }
