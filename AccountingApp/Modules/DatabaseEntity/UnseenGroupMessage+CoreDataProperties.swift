//
//  UnseenGroupMessage+CoreDataProperties.swift
//  AccountingApp
//
...
extension UnseenGroupMessage {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<UnseenGroupMessage> {
        return NSFetchRequest<UnseenGroupMessage>(entityName: "UnseenGroupMessage")
    }
